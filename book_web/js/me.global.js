me.ready(function () {
	...
	me.global("is_pay_map", Util.toMap(me.global.is_pay, "code"));
	...
	me.global("pay_type_map", Util.toMap(me.global.pay_type, "code"));
	...
	me.global("status_map", Util.toMap(me.global.status, "code"));

	me.global("is_marking", [{
		code: 0,
		text:"未阅卷"
	}, {
		code: 1,
	...
	me.global("is_marking_map", Util.toMap(me.global.is_marking, "code"));

    me.global("res", Config.res);

	me.global("slidePath", Config.slidePath);

	me.global("slidePreviewPath", Config.slidePreviewPath);
